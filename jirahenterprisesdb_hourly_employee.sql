...
CREATE TABLE `hourly_employee` (
  ...
  CONSTRAINT `hourly_employee_ibfk_1` FOREIGN KEY (`Employee_ID`) REFERENCES `employee` (`Employee_ID`)
...
INSERT INTO `hourly_employee` VALUES (12350,260),(12351,260),(12353,260),(12354,260),(12355,260);
