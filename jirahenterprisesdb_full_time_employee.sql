...
CREATE TABLE `full_time_employee` (
  ...
  `Fulltime_Rate` int DEFAULT NULL,
  PRIMARY KEY (`Employee_ID`),
  CONSTRAINT `full_time_employee_ibfk_1` FOREIGN KEY (`Employee_ID`) REFERENCES `employee` (`Employee_ID`)
...
INSERT INTO `full_time_employee` VALUES (12345,400),(12346,400),(12347,400),(12348,400),(12349,400),(12352,400);
